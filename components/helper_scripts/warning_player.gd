...
const WARNING_BELL := preload("res://warning_sounds/bell.wav");

const WARNING_VOICES := [
	preload("res://warning_sounds/voice1.wav"),
	preload("res://warning_sounds/voice2.wav"),
	preload("res://warning_sounds/voice3.wav"),
	preload("res://warning_sounds/voice4.wav"),
	preload("res://warning_sounds/voice5.wav")
];
